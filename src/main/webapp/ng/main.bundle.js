...
var BusquedaContratoComponent = (function () {
    ...
    BusquedaContratoComponent.prototype.showIngresoFianza = function (idContrato, numeroContrato, numeroFianza, idCatalogoEstado, fechaFianza) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__historial_estados_historial_estados_component__ = __webpack_require__("../../../../../src/app/historial-estados/historial-estados.component.ts");
...
var DetalleContratoComponent = (function () {
    function DetalleContratoComponent(utilService, activeModal, modalService, contratoService) {
        this.utilService = utilService;
        this.activeModal = activeModal;
        this.modalService = modalService;
        this.contratoService = contratoService;
    ...
    DetalleContratoComponent.prototype.showHistoricoEstados = function () {
        var options = { size: 'lg' };
        var modalRef = this.modalService.open(__WEBPACK_IMPORTED_MODULE_2__historial_estados_historial_estados_component__["a" /* HistorialEstadosComponent */], options);
...
DetalleContratoComponent = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
        ...
        providers: [__WEBPACK_IMPORTED_MODULE_2__historial_estados_historial_estados_component__["a" /* HistorialEstadosComponent */]]
    }),
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_4__services_util_service__["a" /* UtilService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_4__services_util_service__["a" /* UtilService */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_3__ng_bootstrap_ng_bootstrap__["b" /* NgbActiveModal */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3__ng_bootstrap_ng_bootstrap__["b" /* NgbActiveModal */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_3__ng_bootstrap_ng_bootstrap__["c" /* NgbModal */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3__ng_bootstrap_ng_bootstrap__["c" /* NgbModal */]) === "function" && _c || Object, typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_1__services_contrato_service__["a" /* ContratoService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__services_contrato_service__["a" /* ContratoService */]) === "function" && _d || Object])
...
var HistorialEstadosComponent = (function () {
    function HistorialEstadosComponent(activeModal, contratoService, _modalService, confirmationService) {
        this.activeModal = activeModal;
        this.contratoService = contratoService;
    ...
    HistorialEstadosComponent.prototype.showConfirmar = function (idContrato) {
        var _this = this;
        this.confirmationService.confirm({
            message: 'Esta seguro de devolver el contrato?',
            accept: function () {
                _this.cambiarEstadoContrato(idContrato);
            }
        });
    };
    HistorialEstadosComponent.prototype.cambiarEstadoContrato = function (idContrato) {
        var _this = this;
        this.contratoService.actualizaEstados(idContrato).subscribe(function (response) {
            console.log(response);
            _this.activeModal.dismiss('devuelto');
        }, function (error) {
            console.log(error);
        });
    };
...
HistorialEstadosComponent = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
        ...
        providers: [__WEBPACK_IMPORTED_MODULE_4_primeng_primeng__["ConfirmationService"], __WEBPACK_IMPORTED_MODULE_4_primeng_primeng__["ConfirmDialogModule"]]
    }),
...
var ContratoService = (function () {
    ...
    ContratoService.prototype.actualizaEstados = function (idContrato) {
        var params = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["c" /* URLSearchParams */]();
    ...
    ContratoService.prototype.registrarNumeroFianza = function (idContrato, numeroFianza, fechaFianza) {
        var params = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["c" /* URLSearchParams */]();
        params.set('contrato', "" + idContrato);
...
var SolicitudGastoComponent = (function () {
    ...
    SolicitudGastoComponent.prototype.cargaTiposServicios = function () {
