...
AppModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
        ...
        entryComponents: [__WEBPACK_IMPORTED_MODULE_11__addendum_addendum_component__["a" /* AddendumComponent */], __WEBPACK_IMPORTED_MODULE_16__detalle_contrato_detalle_contrato_component__["a" /* DetalleContratoComponent */], __WEBPACK_IMPORTED_MODULE_17__historial_estados_historial_estados_component__["a" /* HistorialEstadosComponent */]],
...
var BusquedaContratoComponent = (function () {
    ...
    BusquedaContratoComponent.prototype.cargaContratos = function () {
        ...
        this.contratoService.getContratos(this.anioActual)
            .subscribe(function (result) { _this.contratos = result; }, function (error) {
...
module.exports = "<div class=\"row\">\n\n\t<div  class=\"col-md-12\">\n\t<table class=\"table  table-striped\">\n\t\t<thead>\n\t\t\t<th>Estado</th>\n\t\t\t<th>Fecha Registro</th>\n\t\t\t<th>Observaciones departe de sobcontraloria</th>\n\t\t\t<th>Descargar Archivo</th>\n\t\t</thead>\n\t\t<tbody>\n\t\t\t<tr *ngFor=\"let estado of estados\" >\t\t\t\t\t\n\t\t\t\t<td>\n\t\t\t\t\t<div class=\"{{estado.idCatalogoEstado==3?'bg-danger':'bg-success'}}  text-white\">\n\t\t\t\t\t\t<label class=\"col-form-label\">{{getNombreEstado(estado.idCatalogoEstado)}}</label>\n\t\t\t\t\t</div>\n\t\t\t\t</td>\n\t\t\t\t<td>\n\t\t\t\t\t<div>\t\t\t\t\t\t\t\n\t\t\t\t\t\t<label class=\"col-form-label text-right\">{{estado.fechaInsert | date:'dd/MM/yyyy hh:mm:ss'}}</label>\n\t\t\t\t\t</div>\n\t\t\t\t</td>\n\t\t\t\t<td>\n\t\t\t\t\t<div>\n\t\t\t\t\t\t<label class=\"col-form-label text-left\">{{estado.observaciones}}</label>\n\t\t\t\t\t</div>\n\t\t\t\t</td>\t\t\t\t\n\t\t\t\t<td>\n\t\t\t\t\t<div class=\"row align-items-center justify-content-center\">\n\t\t\t\t\t\t<a><span *ngIf=\"estado.documento\" class=\"fa fa-cloud-download\" aria-hidden=\"true\" aria-hidden=\"true\"  placement=\"top\" ngbTooltip=\"Descargar\" (click) = \"downloadContratoRechazado()\"></span></a>\n\t\t\t\t\t</div>\n\t\t\t\t</td>\n\t\t\t</tr>\n\t\t</tbody>\n\t</table>\n\t</div>\n</div>"
...
var HistorialEstadosComponent = (function () {
    function HistorialEstadosComponent(activeModal, contratoService) {
        this.activeModal = activeModal;
        this.contratoService = contratoService;
    }
