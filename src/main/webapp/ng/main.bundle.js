...
AppModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
        ...
        entryComponents: [__WEBPACK_IMPORTED_MODULE_11__addendum_addendum_component__["a" /* AddendumComponent */], __WEBPACK_IMPORTED_MODULE_16__detalle_contrato_detalle_contrato_component__["a" /* DetalleContratoComponent */]],
...
var BusquedaContratoComponent = (function () {
    ...
    BusquedaContratoComponent.prototype.cargarRenglones = function () {
        var _this = this;
        this.rueService.getRenglones().subscribe(function (result) { _this.renglones = result; }, function (error) {
            var errorMessage = error;
            console.log(errorMessage);
        });
    };
    ...
    BusquedaContratoComponent.prototype.editar = function (contrato) {
    ...
    BusquedaContratoComponent.prototype.registrarFianza = function () {
        ...
        this.contratoService.registrarNumeroFianza(this.idContrato, this.numeroFianza).subscribe(function (response) {
            console.log(response),
                _this.limpiarFianza();
            _this.muestraMensaje('success', 'Fianza registrada');
        }, function (error) {
            _this.muestraMensaje('error', error);
        });
        //console.log(this.labora);
    };
    BusquedaContratoComponent.prototype.limpiarFianza = function () {
...
var CreaContratoComponent = (function () {
    ...
    CreaContratoComponent.prototype.insertContrato = function (data) {
        var _this = this;
        this.rueService.setContrato(data).subscribe(function (response) {
            console.log(response),
                //this.limpiarForm(f);
    ...
    CreaContratoComponent.prototype.updateContrato = function (data) {
        var _this = this;
    ...
    CreaContratoComponent.prototype.inicializaFormulario = function () {
    };
    ...
    CreaContratoComponent.prototype.search = function (event) {
        ...
        this.rueService
            ...
            .subscribe(function (result) { _this.personas = result; }, function (error) { var errorMessage = error; console.log(errorMessage); });
    };
    ...
    CreaContratoComponent.prototype.seleccionaContratista = function () {
        ...
        this.rueService
            ...
            .subscribe(function (data) { _this.inicializaLaboral(data); }, function (error) { var errorMessage = error; console.log(errorMessage); });
    };
...
var ContratoService = (function () {
    ...
    ContratoService.prototype.getContratos = function (anio) {
        var params = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["b" /* URLSearchParams */]();
